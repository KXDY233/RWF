...
def main():
    ...
    print("exp with degree partitioning, without node feature")
    ### COLLAB PROTEINS
    ...
    for args.tau in [3,4,5,6,7,8,9,10]:
        ...
        embedding_file = args.dataset + '_RWF' + '_' + str(args.k) + '_' + str(args.tau) + '_D.csv'
        ...
        if args.dataset in ["REDDIT-MULTI-K", "DBLP_v1", "reddit_threads", "twitch_egos", "github_stargazers", "deezer_ego_nets"]:
        ...
        file_out = '../../results/' + args.dataset + '_' + str(round(best_mean[idx],3)) + '_' + str(args.k) + '_' + str(args.tau) + '_D.txt'
    ...
    print("exp with degree partitioning, without node feature, varying tau: ")
    print(best)

    best_file = '../../results/' + args.dataset + '_' + str(args.k) + '_D_results.txt'
