...
def main():
    ...
    print("exp without graph partitioning")
    ### COLLAB PROTEINS
    ...
    for args.tau in [3,4,5,6,7,8,9,10]:
        ...
        embedding_file = args.dataset + '_LM' + '_' + str(args.k) + '_' + str(args.tau) + '_W.csv'
        ...
        if args.dataset in ["REDDIT-MULTI-12K", "DBLP_v1", "reddit_threads", "twitch_egos", "github_stargazers", "deezer_ego_nets"]:
        ...
        file_out = '../../results/' + args.dataset + '_' + str(round(best_mean[idx],3)) + '_' + str(args.k) + '_' + str(args.tau) + '_W.txt'
    ...
    print("exp without graph partitioning, varying tau: ")
    print(best)

    best_file = '../../results/' + args.dataset + '_' + str(args.k) + '_W_results.txt'
